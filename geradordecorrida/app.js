...
/* ======= Geração ======= */
  ...
  for (let i=0; i<nTreinos; i++) {
    ...
    if (!treino) treino = {nome:"Rodagem leve", tipo:"leve", distKm:rng(0.6,0.9)* (volMaxKm/nTreinos), desc:"Respiração controlada + técnica", leve:true};
...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', ()=> navigator.serviceWorker.register('./sw.js').then(()=>console.log("✅ SW ativo")));
}
